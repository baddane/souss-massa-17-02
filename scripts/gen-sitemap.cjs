...
async function main() {
  ...
  const staticPages = [
    ...
    // '/inscription-candidat' retire : la page redirige tant que les
    // inscriptions candidat sont fermees, l'indexer enverrait Google sur
    // une redirection. Remis a la reouverture, comme dans api/sitemap.ts.
